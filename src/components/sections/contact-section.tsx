        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4 md:space-y-8">
              <a
                href="mailto:hello@repetonline.ru"
              ...
              >
                ...
                <p className="text-base text-foreground md:text-2xl">8 800 555-XX-XX</p>
              </div>
              ...
              >
                ...
                <p className="text-base text-foreground md:text-2xl">Россия, онлайн по всему миру</p>
              </div>
